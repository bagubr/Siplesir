                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('permohonan.update', $permohonan->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <input id="alamat_imb" type="text" class="form-control @error('alamat_imb') is-invalid @enderror" value="{{ old('alamat_imb', $permohonan->alamat_imb) }}" name="alamat_imb" required autocomplete="alamat_imb">
                                @error('alamat_imb')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
